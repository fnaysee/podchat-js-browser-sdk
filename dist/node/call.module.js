  ...
  function ChatCall(params) {
    ...
    var Utility = params.Utility,
      ...
      'VIDEO': 0x1
        ...
        callVideoMinWidth = params.callOptions && params.callOptions.hasOwnProperty('callVideo') && typeof params.callOptions.callVideo === 'object' && params.callOptions.callVideo.hasOwnProperty('minWidth') ? params.callOptions.callVideo.minWidth : 320,
        callVideoMinHeight = params.callOptions && params.callOptions.hasOwnProperty('callVideo') && typeof params.callOptions.callVideo === 'object' && params.callOptions.callVideo.hasOwnProperty('minHeight') ? params.callOptions.callVideo.minHeight : 180,
        currentCallParams = {},
        currentCallId = null,
        newCallId = null,
    ...
    reformatCallParticipants = function (participantsContent) {
      ...
      if (callUsers) {
        ...
        if (me) {
          if (me.video) releaseResource('video');
          if (!me.mute) releaseResource('audio');
        }
      }
      ...
      let videoTrack = videoElement.srcObject && videoElement.srcObject.getTracks() && videoElement.srcObject.getTracks().length ? videoElement.srcObject.getTracks()[0] : null;
    ...
    this.handleChatMessages = function (type, chatMessageVOTypes, messageContent, contentCount, threadId, uniqueId) {
      switch (type) {
        ...
        case chatMessageVOTypes.START_CALL:
          ...
          if (typeof messageContent === 'object' && messageContent.hasOwnProperty('chatDataDto') && !!messageContent.chatDataDto.kurentoAddress) {
        ...
        case chatMessageVOTypes.CALL_SESSION_CREATED:
          ...
          if (!currentCallId) currentCallId = messageContent.callId;else newCallId = messageContent.callId; //currentCallId = messageContent.callId;
